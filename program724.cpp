...
void DisplayHelp()
{
    ...
    printf("man : It is used to display the specific manualpage of the command\n");
    ...
    printf("creat : it is used to crate new file\n");
    printf("unlink : it is used to delete an existing file\n");
    printf("stat : It is used to display statistical information about the file\n");
    printf("ls : it is used to display all the files of the directory\n");
            ...
            )
{
    ...
    {
        printf("Description : This command is used to delete regular file on our file system\n");
    ...
    {
        printf("Description : This command is used to display statistical information about the file on our file system\n");

        printf("Usage : stat File_name \n");
        printf("File_name : The name of file whose information u want to display\n");
        
    }

    else if(strcmp(name,"ls") == 0)
    {
        printf("Description : This command is used to list all file namesfrom our directory\n");
        printf("Usage : stat File_name \n");
    ...
    else if(strcmp(name,"read")== 0)
    {
        ...
        printf("file Descriptor : its a value returned by create system call\n");
    ...
    {   
        if(uareaobj.UFDT[i] != NULL)
        {
            if(strcmp(uareaobj.UFDT[i] ->ptrinode->FileName,name) == 0 )
            {
                ...
                //Deallocte memory of file table
...
//  Description :       It is used to display name of all files in the directory
//  Input :             Nothing
//  Output :            Nothing
//  Author :            Ujjwal Dattatraya Patil
//  Date :              15/08/2025
...
//  Description :       It is used to display information about the given files in the directory
//  Input :             Nothing
//  Output :            Nothing
//  Author :            Ujjwal Dattatraya Patil
//  Date :              15/08/2025
...
//                      Size of Data that we wnat to write
//  Output :            number of bytes we want to write
//  Author :            Ujjwal Dattatraya Patil
//  Date :              15/08/2025
//
///////////////////////////////////////////////////////////////////////
                ...
                )
{
    ...
    printf("Data that we have to write : %s\n",data);
    printf("number of bytes that we want to write is %d\n",size);
...
//  Description :       It is used to read the content of the file
//  Input :             File Descriptor
//                      Address of the empty Buffer which contains Data
//                      Size of Data that we wnat to write
//  Output :            number of bytes we want to read from the file
//  Author :            Ujjwal Dattatraya Patil
//  Date :              15/08/2025
//
///////////////////////////////////////////////////////////////////////
...
int read_file(
                ...
                char *data,     //address of the buffer
                int size        // number of bytes we want to read
)
{
    //Invalid value of FD
    if(fd < 0 || fd > MAXOPENEDFILES)
    ...
    while(1)
    {
        ...
        else if(iCount == 2)
        {
            ...
            else if(strcmp(Command[0],"unlink") == 0)
            {
                ...
                {
                    printf("Unlink operaation is successfully performed");
                }

                else if(iRet == ERR_FILE_NOT_EXIST)
                {
                    printf("Error: Unable to dp unlink activity as file is not present");
                }
            ...
            else if(strcmp(Command[0],"stat") == 0)
            {
                ...
                {
                    printf("Error: Unable to do statistical activity as file is not present");
                }
            ...
            {
                printf("please enter the data u want to write into the file : \n");
                ...
                {
                    printf("Error : unable to write as there is no permission granted\n");
                }
                else if(iRet == ERR_INVALID_PARAMETER)
                {
                    printf("Error : Invalid parameters for the function\n");
                ...
                {
                    printf(" %d byte data is succesfully written into the file\n",iRet);
        ...
        else if(iCount == 3)
        {
            ...
            else if(strcmp(Command[0],"read") == 0)
            {
                ...
                {
                    printf("Error : unable to read as there is no permission granted\n");
                }
                else if(iRet == ERR_INVALID_PARAMETER)
                {
                    printf("Error : Invalid parameters for the function\n");
